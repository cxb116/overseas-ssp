...
func AesECBEncryptHex(plaintext string, keyHex string) (string, error) {
	...
	// 3. PKCS7 填充
	data := pkcs7Padding([]byte(plaintext), blockSize)
...
func main() {
	...
	//decryptHex, err := AesECBDecryptHex(encryptHex, "c65b05b1ba9ae8570d999540e71b55bf9b242b761d6fa953ccbff299da267600")
	//if err != nil {
	//	panic(err)
	//}
